...
import DailyCmfLineChart from "./Charts/DailyCmfLineChart";
...
import WeeklyCmfLineChart from "./Charts/WeeklyCmfLineChart";
...
const RowChart = React.memo(({ row, t }: { row: any; t: string }) => {
  ...
  return (
    <Box>
      ...
      {chartType === ChartType.HOURLY_CMF && (
        <HourlyCmfLineChart stock_id={row.stock_id} t={t} />
      )}
      ...
      {chartType === ChartType.DAILY_CMF && (
        <DailyCmfLineChart stock_id={row.stock_id} t={t} />
      )}
      ...
      {chartType === ChartType.WEEKLY_CMF && (
        <WeeklyCmfLineChart stock_id={row.stock_id} t={t} />
      )}
    </Box>
  );
});

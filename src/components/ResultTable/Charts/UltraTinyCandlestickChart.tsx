  ...
  return (
    <ResponsiveContainer width={80} height={60}>
      ...
      >
        ...
        <Line dataKey="h" stroke="#fff" opacity={0} dot={false} activeDot={false} isAnimationActive={false} />
        <Line dataKey="c" stroke="#fff" opacity={0} dot={false} activeDot={false} isAnimationActive={false} />
        <Line dataKey="l" stroke="#fff" opacity={0} dot={false} activeDot={false} isAnimationActive={false} />
        <Line dataKey="o" stroke="#fff" opacity={0} dot={false} activeDot={false} isAnimationActive={false} />

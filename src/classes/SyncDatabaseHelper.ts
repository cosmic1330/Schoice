    ...
    try {
      ...
      const entries = skills.map(s => {
        const values = [
          ...
          this.sqlSafe(s.ema5), this.sqlSafe(s.ema10), this.sqlSafe(s.ema20), this.sqlSafe(s.ema60), this.sqlSafe(s.ema120), this.sqlSafe(s.ema200),

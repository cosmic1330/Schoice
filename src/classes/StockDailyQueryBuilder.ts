...
export class StockDailyQueryBuilder extends BaseQueryBuilder {
  protected mapping: Record<string, QueryBuilderMappingItem> = {
    ...
    ma30: { key: "ma30", group: "_day_ago_sk" },
    ma30扣抵: { key: "ma30_ded", group: "_day_ago_sk" },
    ma50: { key: "ma50", group: "_day_ago_sk" },
    ma50扣抵: { key: "ma50_ded", group: "_day_ago_sk" },
    ...
    ma240: { key: "ma240", group: "_day_ago_sk" },
    ma240扣抵: { key: "ma240_ded", group: "_day_ago_sk" },
    ...
    ema200: { key: "ema200", group: "_day_ago_sk" },
